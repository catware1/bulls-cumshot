...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Стоп, что?") action Rollback()
            textbutton _("История") action ShowMenu('history')
            textbutton _("Спидран") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Авто") action Preference("auto-forward", "toggle")
            textbutton _("Сейв") action ShowMenu('save')
            textbutton _("Быстрый сейв") action QuickSave()
