...
define config.name = "СПЕРМА БЫКА"
...
define config.version = "ВЕРСИЯ ДВА"
...
define gui.about = _p("""
50к в сумке у папы (В сумке, у папы)
50к в сумке у папы (В сумке, у папы)
...
define build.name = "BullsCumshot"
...
define config.save_directory = "BullsCumshot-1647470099"
